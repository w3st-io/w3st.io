...
<body>
	<!-- NavBar -->
	<div class="border-bottom border-danger thick-border">
		<div class="container">
			<div class="row">
	...
	<div class="container">
		<div class="row">
			<!-- Title -->
			<div class="col-12 border-bottom border-dark thick-border">
				<h1
			...
			<!-- Status Section -->
			<div class="col-lg-4 border-right border-dark status-section thick-border text-uppercase">
